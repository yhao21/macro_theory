...
\begin{figure}[H]
\center{\includegraphics[scale =.5 ]  {figures/calculate_CPI.png}}
\end{figure}
...
\begin{figure}[H]
\center{\includegraphics[scale =.4 ]  {figures/NX_real_interest_rate.png}}
\end{figure}
...
\begin{figure}[H]
\center{\includegraphics[scale =.4 ]  {figures/real_exchange_rate_S_I.png}}
\end{figure}
...
\begin{figure}[H]
\center{\includegraphics[scale =.4 ]  {figures/G_affect_real_exchange_rate.png}}
\end{figure}
...
If foreign governments increase $ G $ or cut taxes, the world saving goes down (
recall that we consider the world economy as a big closed economy).
Then, world saving curve shift to the left, the world real interest rate, $ r^{*} $,
goes up.

\begin{figure}[ht]
    \centering
    \scalebox{.7}{\incfig{foreign-g-affects-world-real-interest-rate}}
    \caption{foreign G affects world real interest rate}
    \label{fig:foreign-g-affects-world-real-interest-rate}
\end{figure}
...
\begin{figure}[H]
\center{\includegraphics[scale =.4 ]  {figures/change_investment_affect_exchange_rate.png}}
\end{figure}
...
\begin{figure}[H]
\center{\includegraphics[scale =.4 ]  {figures/protectionist_policies.png}}
\end{figure}
...
\noindent\fbox{%
\parbox{\textwidth}{%
		{\textbf {The law of one price}} and {\textbf {purchasing power parity (PPP)}}:

The law of one price: the same good cannot sell for different prices in different 
locations at the same time. It is because people will buy from where the price is low
and sell to where the price is high.

In macroeconomic, it is called purchasing power parity. A currency must have the
...
\begin{figure}[H]
\center{\includegraphics[scale =.4 ]  {figures/PPP_NX.png}}
\end{figure}
...
\begin{figure}[H]
\center{\includegraphics[scale =.4 ]  {figures/CF_r.png}}
\end{figure}
...
\begin{figure}[H]
\center{\includegraphics[scale =.5 ]  {figures/CF_closed_SOE.png}}
\end{figure}
...
\begin{figure}[H]
\center{\includegraphics[scale =.5 ]  {figures/S=I+CF.png}}
\end{figure}
...
\begin{figure}[H]
\center{\includegraphics[scale =.5 ]  {figures/NX=CF.png}}
\end{figure}
...
\begin{figure}[H]
\center{\includegraphics[scale =.5 ]  {figures/S_r_CF_eps.png}}
\end{figure}
...
\begin{figure}[H]
\center{\includegraphics[scale =.5 ]  {figures/LOE_domestic_fiscal_policy.png}}
\end{figure}

\noindent\fbox{%
\parbox{\textwidth}{%
Comparison of the effect of domestic fiscal policy under closed economy, SOE, and LOE:
\begin{equation*}
S = I + NX
\end{equation*}

For an expansionary fiscal policy at home,\\
Closed economy: S goes down, thus I goes down equally (no borrowing and lending, NX
= 0).

SOE: S goes down, NX goes down equally while I is constant because $ I $ is determined
by the world real interest rate. 

LOE: S goes down, both I and NX go down.
...
\begin{figure}[H]
\center{\includegraphics[scale =.45 ]  {figures/increase_investment_demand_CF_NX.png}}
\end{figure}
...
\begin{figure}[H]
\center{\includegraphics[scale =.4 ]  {figures/protectionist_policies_CF.png}}
\end{figure}
...
\begin{figure}[H]
\center{\includegraphics[scale =.4 ]  {figures/shift_in_CF.png}}
\end{figure}
